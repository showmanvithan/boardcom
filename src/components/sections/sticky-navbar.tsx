...
export default function StickyNavbar({name} : NavBarProfileNameProps) {
    return (
                <div className="sticky top-0 left-0 w-full  border border-dashed bg-white dark:bg-black/80 flex pl-5 border-zinc-800 dark:border-zinc-500 backdrop-blur z-1000">
