...
export default function ExperienceCake() {
    return (
        <div className="dark:bg-zinc-900 bg-white dark:text-zinc-100 text-zinc-900 border dark:border-zinc-800 border-zinc-200 rounded-3xl   p-5 ml-3 mr-3 overflow-scroll h-70  ">
                    ...
                    <div key={i} className="flex gap-4 relative pb-5 last:pb-0">
                        ...
                        <div className="flex-1 pt-0.5">
                            ...
                            <div className="flex flex-wrap gap-1.5 mt-2.5">
                                {exp.tags.map((tag) => (
                                    <span key={tag} className="text-xs dark:bg-zinc-800 bg-zinc-100 dark:text-zinc-400 text-zinc-600 dark:border-zinc-700 border-zinc-200 border rounded-full px-2.5 py-0.5">
                                        {tag}
                                    </span>
                                ))}
                            </div>
