...
export default function BrandsCake() {
    ...
    return (
        ...
        <div className="flex md:flex-row flex-col border border-dashed border-zinc-600 dark:bg-zinc-950 bg-white z-100 ">
            ...
            <div className="relative flex flex-2 md:border-l md:border-t-0 border-t border-dashed border-zinc-600 overflow-hidden items-center justify-center pt-2 text-zinc-900 dark:text-zinc-200">
                <LogoLoop
                    logos={techLogos}
                    speed={30}
                    direction="left"
