...
import ShowProjectsCake from "@/components/sections/showprojects";
...
export default function Bio() {
    ...
    return (
        <div className=" bg-white dark:bg-black h-screen flex justify-evenly overflow-x-hidden">
            ...
            <div className=" flex flex-col gap-3 md:border-l md:border-r border-0 border-dashed bg-zinc-50 dark:bg-zinc-950 md:w-200 w-full p-3 border-zinc-800 overflow-scroll no-scroll">
                <Noise
                    patternSize={1}
                    patternScaleX={1}
                    patternScaleY={1}
